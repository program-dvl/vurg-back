...
class BitGoExpress {
     ...
     * @return array
     */
    public function generateWallet(string $label, string $passphrase=null, string $userKey = null, string $backupXpub = null, string $backupXpubProvider = null, string $enterprise = null, bool $disableTransactionNotifications = null, int $gasPrice = null, string $passcodeEncryptionCode = null) {
