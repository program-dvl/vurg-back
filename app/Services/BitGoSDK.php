...
class BitGoSDK {
     ...
     * @return array
     */
    public function createWallet(string $coin, string $label = null, $m = 2, $n = 3) { //dd($this->getString(32));
        $this->url = $this->APIEndpoint .'/wallet';
        $this->params = [
            'coin' => $coin,
            'label' => $label,
            ...
            'n' => $n,
            'keys' => [
                "xprv9s21ZrQH143K2SN4jtbPkH3ruDVsrPaNCkoConZEUrb6si7QyAfVJ7ydTFY8GyQAUhChsJvumDWg5w3k2sL1jNi9PGRB2pXtexGAUvgtL9B",
                "xprv9s21ZrQH143K3Gxc1zSg6Y18xp1sjwVnsw6HzLcZ2zRcVLpFZT7eEpc4XiXpEu6gXARqYJj8H59atrA8p6TjA1pNqW4uFQgNKkGgXJGLTn1",
                "xprv9s21ZrQH143K4T9QCjH1VgP2G2aATMcKBtqEht42eq9MguMmDrMVDqVKfFjExk3GHzetBgKK5hDjNiHk5h36xoyn5LbwZU1XBB5ioMoEwVc"
            ]
        ];
        return $this->__execute();
    }
